...
# Verified Hamro Patro 2025 festival dates
HAMRO_PATRO_2025 = {
...
for festival_date, festival_name in HAMRO_PATRO_2025.items():
    CalendarEvent.objects.create(
        title=festival_name,
        description="Hamro Patro verified date",
...
print(f"Added {len(HAMRO_PATRO_2025)} Hamro Patro festivals")

for festival_date, festival_name in sorted(HAMRO_PATRO_2025.items()):
