...
urlpatterns = [
    ...
    path('todays-collection/', views.todays_collection, name='todays_collection'),
    path('weekly-collection/', views.weekly_collection, name='weekly_collection'),
    path('monthly-collection/', views.monthly_collection, name='monthly_collection'),
    path('yearly-collection/', views.yearly_collection, name='yearly_collection'),
