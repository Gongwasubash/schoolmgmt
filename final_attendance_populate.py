...
for school_day in school_days:
    for student_id in students:
        ...
        with connection.cursor() as cursor:
            cursor.execute(
                "INSERT OR IGNORE INTO schoolmgmt_studentattendance (student_id, date, status, marked_by, created_at, updated_at) VALUES (%s, %s, %s, %s, %s, %s)",
                [student_id, school_day, status, 'Auto System', now, now]
            )
